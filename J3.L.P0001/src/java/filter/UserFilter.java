 ...
 * @author dinhd
 */
@WebFilter(filterName = "UserFilter", urlPatterns = {"/scoreController","/createQuiz", "/viewQuiz"})
public class UserFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        //if account has role equal 0(normal user), users cannot intentionally
        ...
        }else if(session.getAttribute("account") != null&&accountEntity.getRoleUser() == 0){
             httpRespond.sendRedirect("homeControl");
        }
